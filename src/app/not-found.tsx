  ...
  return (
    <div className="min-h-[70vh] flex flex-col justify-center animate-reveal max-w-2xl px-1">
      ...
      <div className="mb-10 border border-white/10 rounded-lg bg-white/[0.02] overflow-hidden shadow-2xl">
        <div className="px-4 py-2 border-b border-white/10 bg-white/[0.03] text-[9px] font-mono text-white/70 uppercase tracking-widest font-bold">
          Diagnostic Report
        </div>
      ...
      <div className="space-y-4 md:space-y-6">
        <p className="text-[9px] font-mono uppercase tracking-[0.4em] text-white/70 font-bold px-1">System Recovery:</p>
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/work" className="px-5 md:px-8 py-2.5 md:py-3 bg-white/[0.01] border border-white/5 rounded-md text-[10px] font-mono uppercase tracking-widest text-white/75 hover:text-white transition-all">
            Work
          </Link>
          <Link href="/journey" className="px-5 md:px-8 py-2.5 md:py-3 bg-white/[0.01] border border-white/5 rounded-md text-[10px] font-mono uppercase tracking-widest text-white/75 hover:text-white transition-all">
            Journey
          </Link>
        </div>
      </div>
